...
const roles = ["Fullstack", "Backend", "Creative", "Problem Solver"];
...
export const Hero: React.FC = () => {
    ...
    return (
        <section ref={containerRef} id="home" className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center text-center">
            <Navbar />
            ...
            <div className="relative z-10 px-6 max-w-4xl">
                ...
                <div className="blur-in text-lg md:text-xl text-text-primary mb-4 h-8 flex items-center justify-center gap-2">
                    A{" "}
                    <span key={roleIndex} className="font-display italic animate-role-fade-in inline-block text-accent">
                        {roles[roleIndex]}
                    </span>{" "}
                    lives in Dhaka.
                </div>
                <p className="blur-in text-sm md:text-base text-muted max-w-md mx-auto mb-12">
                    Software developer crafting efficient, scalable applications and seamless digital interactions.
                </p>
