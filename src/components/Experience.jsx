...
const experienceData = [
    {
        ...
        period: '2023 - Present',
        description: 'Leading the frontend development of core products using React and Next.js. Improved site performance by 40% and implemented a new design system.',
    },
    {
        company: 'Creative Agency',
        role: 'Web Developer Intern',
        period: '2022 - 2023',
        description: 'Collaborated with designers to translate Figma mockups into responsive web pages. Built interactive components using JavaScript and Tailwind CSS.',
    },
]
                ...
                <div className="max-w-3xl mx-auto">
                    {experienceData.map((exp, index) => (
                        ...
                        >
                            ...
                            <div className="bg-[#111] border border-white/5 p-6 rounded-2xl hover:border-white/10 transition-colors">
